...
async function main() {
	...
	if (Object.prototype.hasOwnProperty.call(projectEnv, 'TURSO_DB_URL')) {
		childEnv.TURSO_DB_URL = projectEnv.TURSO_DB_URL;
	}
	if (Object.prototype.hasOwnProperty.call(projectEnv, 'TURSO_DB_AUTH_TOKEN')) {
		childEnv.TURSO_DB_AUTH_TOKEN = projectEnv.TURSO_DB_AUTH_TOKEN;
	}
